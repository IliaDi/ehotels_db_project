...
<form method="post" action="/ReservedIRS.php">
<div class="solid"><br>
<b>Hotel</b><br>
...
<br><hr>
IRS Number:
<input type="text" name="IRS" required><br>
<p class="note">We found more than one customer with your Name. IRS number required.</p>
<br>
